...
def write_regional_intent_pages(listings):
    ...
    for path, title, description, matches in pages:
        ...
        item_list = {"@context":"https://schema.org","@type":"ItemList","name":title,"numberOfItems":len(matches),"itemListElement":[{"@type":"ListItem","position":position,"url":f"{SITE}/listings/{item['slug']}/","name":item["address"]} for position,item in enumerate(matches,1)]}
        page = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{escape(title)} | Total Realty Source</title><meta name="description" content="{escape(description)}"><link rel="canonical" href="{canonical}"><meta property="og:type" content="website"><meta property="og:title" content="{escape(title)}"><meta property="og:description" content="{escape(description)}"><link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Bodoni+Moda:wght@500;700&family=Lora:wght@400;600;700&display=swap" rel="stylesheet"><style>{CSS}</style><script type="application/ld+json">{json.dumps([breadcrumb,collection,item_list])}</script></head><body>{site_header('../../')}<main class="shell"><nav class="crumbs"><a href="../../index.html">Home</a> / {escape(title)}</nav><h1>{escape(title)}</h1><p class="intro">{escape(description)} Listing availability changes frequently, so contact a local agent to confirm current status and schedule a showing.</p><div class="category-links"><a href="../../forsale.html">Search all West Tennessee properties</a><a href="../../contact.html">Ask a local agent</a></div><h2>Current matching West Tennessee properties</h2><div class="listing-grid">{''.join(card(item) for item in matches) or '<p>No matching properties are displayed right now. Contact our team for recently added options.</p>'}</div><h2>More ways to search</h2><div class="nearby"><a href="../../homes-for-sale/jackson-tn/">Jackson homes for sale</a><a href="../../homes-for-sale/humboldt-tn/">Humboldt homes for sale</a><a href="../../homes-for-sale/medina-tn/">Medina homes for sale</a><a href="../../jackson-tn/new-construction/">New homes in Jackson</a></div></main>{site_footer('../../')}</body></html>'''
        (folder / "index.html").write_text(page, encoding="utf-8")
        urls.append(canonical)
    return urls
